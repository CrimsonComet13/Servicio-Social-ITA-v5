...
// Filtros
$tipoFiltro = $_GET['tipo'] ?? 'todos'; // todos, bimestral
$estadoFiltro = $_GET['estado'] ?? 'pendiente'; // pendiente, evaluado, todos

// Obtener reportes bimestrales pendientes
$whereConditionsBimestral = ["s.jefe_laboratorio_id = :jefe_id"];
$paramsBimestral = ['jefe_id' => $jefeLabId];
...
$totalPendientes = $bimestralesPendientes;
$totalEvaluados = $bimestralesEvaluados;
...
.evaluation-status.pendiente_evaluacion {
    background: #fef3c7;
    color: #92400e;
}
...
<div class="dashboard-content">
    ...
    <div class="page-header">
        <h1>
            ...
            Evaluaciones de Reportes Bimestrales
        </h1>
        <p>Gestiona y evalúa los reportes bimestrales de los estudiantes de tu laboratorio</p>
    </div>
    ...
    <div class="evaluations-section">
        ...
        <?php if (empty($reportesBimestrales)): ?>
            ...
            <div class="evaluations-grid">
                ...
                <div class="evaluation-card">
                    ...
                    <div class="evaluation-actions">
                        ...
                        <a href="evaluar-reporte.php?id=<?= $reporte['id'] ?>" class="btn btn-primary btn-sm">
                            <i class="fas fa-star"></i> Evaluar Reporte
                        </a>
                        <?php else: ?>
                        <a href="evaluar-reporte.php?id=<?= $reporte['id'] ?>" class="btn btn-secondary btn-sm">
